...
export default function Profile() {
  ...
  return (
    <>
      <div className="flex-1 w-full pt-4.5 pb-8 px-4" style={{ opacity: 1, transform: 'none' }}>
        <div
            ...
            <div className="flex flex-col md:grid md:grid-cols-2 gap-8 lg:gap-22.5">
              <div className="space-y-6 md:order-last md:mt-8 h-full">
                ...
                <div className="space-y-2">
                  <button
                    className="justify-center whitespace-nowrap text-sm font-medium focus:outline-none focus-visible:outline-none disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 cursor-pointer font-britti-sans rounded-full transition-all duration-200 active:scale-[0.98] disabled:active:scale-100 text-primary bg-brand-monad-purple-600-a11y-btn opacity-50 h-9 px-3 flex items-center gap-2 w-full"
                    disabled={true}
                    type="button"
                  >
