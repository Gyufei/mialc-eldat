...
module.exports = {
  ...
  async headers() {
    const connectSrc = [
      ...
      // IP detection endpoints used by analytics
      'https://api.ipify.org',
      'https://ipapi.co',
      'https://httpbin.org',
      'https://api.my-ip.io',
    ...
    const csp = [
      ...
      "img-src 'self' data: blob: https://cdn.tadle.com https://explorer-api.walletconnect.com https://www.googletagmanager.com https://www.google-analytics.com",
